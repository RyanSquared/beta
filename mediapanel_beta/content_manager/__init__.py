...
# Resources
blueprint.add_url_rule("/<type>/<target_id>/resources",
                       view_func=ListResources.as_view("list_resources"))
blueprint.add_url_rule("/<type>/<target_id>/resources/new",
                       view_func=NewResource.as_view("upload_resource"))
blueprint.add_url_rule("/<type>/<target_id>/resources/manage/<resource_id>",
